        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16'>
          ...
          <div>
            ...
            <p className='text-gray-600 mb-8'>
              For commercial projects, events, or other creative work, reach out by phone or email and we&apos;ll
            ...
            <div className='space-y-6'>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <div className='text-gray-900'>Based in Southern Virginia | available for travel</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-col justify-center gap-6 w-full'>
            ...
            {/* SCHEDULER BOX */}
            <div className='bg-white p-8 rounded-lg border border-gray-200 w-full'>
