        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Real estate agents can book photo and video shoots directly using
              the scheduling link.
            </p>
            <p className="text-gray-600 mb-8">
              For commercial projects, events, or other creative work, reach out
              by phone or email and we&apos;ll talk through the details.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:hello@dylanhoodmedia.com"
          ...
          <div className="flex flex-col justify-center gap-6">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                ...
                <p>
                  For commercial and event projects, reach out and I&apos;ll
                  tailor a custom quote.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-6">
                Book your real estate photography or video session using my
                online scheduler.
              </p>
              <a
